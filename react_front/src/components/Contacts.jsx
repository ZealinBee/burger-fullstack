  ...
  return (
    <footer id="contact">
      <div className="content">
        <div className="left box">
          <div className="upper">
            ...
            <p>
              Streamline your coffee experience with our Coffee Ordering System.
              Customize, order, and enjoy your favorite brew hassle-free. It's
              coffee made easy!
            </p>
          </div>
          <div className="lower">
      ...
      <div className="bottom">
        <p>
          Copyright © 2020 <a href="#">CIS 1202</a> All rights reserved
        </p>
      </div>
    </footer>
  );
